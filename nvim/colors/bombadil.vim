...
let s:bomb0_gui = "#2E3440"
let s:bomb1_gui = "#3B4252"
...
"+--- Editor ---+
call s:hi("ColorColumn", "", s:bomb1_gui, "NONE", s:nord1_term, "", "")
call s:hi("Cursor", s:bomb0_gui, s:nord4_gui, "", "NONE", "", "")
call s:hi("CursorLine", "", s:bomb1_gui, "NONE", s:nord1_term, "NONE", "")
call s:hi("Error", s:nord4_gui, s:nord11_gui, "", s:nord11_term, "", "")
call s:hi("iCursor", s:bomb0_gui, s:nord4_gui, "", "NONE", "", "")
...
call s:hi("Normal", s:nord4_gui, s:bomb0_gui, "NONE", "NONE", "", "")
...
call s:hi("SpellBad", s:nord11_gui, s:bomb0_gui, s:nord11_term, "NONE", "undercurl", s:nord11_gui)
call s:hi("SpellCap", s:nord13_gui, s:bomb0_gui, s:nord13_term, "NONE", "undercurl", s:nord13_gui)
call s:hi("SpellLocal", s:nord5_gui, s:bomb0_gui, s:nord5_term, "NONE", "undercurl", s:nord5_gui)
call s:hi("SpellRare", s:nord6_gui, s:bomb0_gui, s:nord6_term, "NONE", "undercurl", s:nord6_gui)
call s:hi("Visual", "", s:nord2_gui, "", s:nord1_term, "", "")
call s:hi("VisualNOS", "", s:nord2_gui, "", s:nord1_term, "", "")
"+- Neovim Support -+
call s:hi("healthError", s:nord11_gui, s:bomb1_gui, s:nord11_term, s:nord1_term, "", "")
call s:hi("healthSuccess", s:nord14_gui, s:bomb1_gui, s:nord14_term, s:nord1_term, "", "")
call s:hi("healthWarning", s:nord13_gui, s:bomb1_gui, s:nord13_term, s:nord1_term, "", "")
call s:hi("TermCursorNC", "", s:bomb1_gui, "", s:nord1_term, "", "")

"+- Vim 8 Terminal Colors -+
if has('terminal')
  let g:terminal_ansi_colors = [s:bomb1_gui, s:nord11_gui, s:nord14_gui, s:nord13_gui, s:nord9_gui, s:nord15_gui, s:nord8_gui, s:nord5_gui, s:nord3_gui, s:nord11_gui, s:nord14_gui, s:nord13_gui, s:nord9_gui, s:nord15_gui, s:nord7_gui, s:nord6_gui]
endif

"+- Neovim Terminal Colors -+
if has('nvim')
  let g:terminal_color_0 = s:bomb1_gui
...
"+--- Gutter ---+
call s:hi("CursorColumn", "", s:bomb1_gui, "NONE", s:nord1_term, "", "")
if g:nord_cursor_line_number_background == 0
  call s:hi("CursorLineNr", s:nord4_gui, "", "NONE", "", "NONE", "")
else
  call s:hi("CursorLineNr", s:nord4_gui, s:bomb1_gui, "NONE", s:nord1_term, "NONE", "")
endif
call s:hi("Folded", s:nord3_gui, s:bomb1_gui, s:nord3_term, s:nord1_term, s:bold, "")
call s:hi("FoldColumn", s:nord3_gui, s:bomb0_gui, s:nord3_term, "NONE", "", "")
call s:hi("SignColumn", s:bomb1_gui, s:bomb0_gui, s:nord1_term, "NONE", "", "")

"+--- Navigation ---+
call s:hi("Directory", s:nord8_gui, "", s:nord8_term, "NONE", "", "")

"+--- Prompt/Status ---+
call s:hi("EndOfBuffer", s:bomb1_gui, "", s:nord1_term, "NONE", "", "")
...
if g:nord_uniform_status_lines == 0
  ...
  call s:hi("StatusLineNC", s:nord4_gui, s:bomb1_gui, "NONE", s:nord1_term, "NONE", "")
  call s:hi("StatusLineTerm", s:nord8_gui, s:nord3_gui, s:nord8_term, s:nord3_term, "NONE", "")
  call s:hi("StatusLineTermNC", s:nord4_gui, s:bomb1_gui, "NONE", s:nord1_term, "NONE", "")
else
  call s:hi("StatusLine", s:nord8_gui, s:nord3_gui, s:nord8_term, s:nord3_term, "NONE", "")
...
call s:hi("WarningMsg", s:bomb0_gui, s:nord13_gui, s:nord1_term, s:nord13_term, "", "")
call s:hi("WildMenu", s:nord8_gui, s:bomb1_gui, s:nord8_term, s:nord1_term, "", "")

"+--- Search ---+
call s:hi("IncSearch", s:nord6_gui, s:nord10_gui, s:nord6_term, s:nord10_term, s:underline, "")
call s:hi("Search", s:bomb1_gui, s:nord8_gui, s:nord1_term, s:nord8_term, "NONE", "")

"+--- Tabs ---+
call s:hi("TabLine", s:nord4_gui, s:bomb1_gui, "NONE", s:nord1_term, "NONE", "")
call s:hi("TabLineFill", s:nord4_gui, s:bomb1_gui, "NONE", s:nord1_term, "NONE", "")
...
if g:nord_bold_vertical_split_line == 0
  call s:hi("VertSplit", s:nord2_gui, s:bomb0_gui, s:nord3_term, "NONE", "NONE", "")
else
  call s:hi("VertSplit", s:nord2_gui, s:bomb1_gui, s:nord3_term, s:nord1_term, "NONE", "")
endif
...
if g:nord_uniform_diff_background == 0
  call s:hi("DiffAdd", s:nord14_gui, s:bomb0_gui, s:nord14_term, "NONE", "inverse", "")
  call s:hi("DiffChange", s:nord13_gui, s:bomb0_gui, s:nord13_term, "NONE", "inverse", "")
  call s:hi("DiffDelete", s:nord11_gui, s:bomb0_gui, s:nord11_term, "NONE", "inverse", "")
  call s:hi("DiffText", s:nord9_gui, s:bomb0_gui, s:nord9_term, "NONE", "inverse", "")
else
  call s:hi("DiffAdd", s:nord14_gui, s:bomb1_gui, s:nord14_term, s:nord1_term, "", "")
  call s:hi("DiffChange", s:nord13_gui, s:bomb1_gui, s:nord13_term, s:nord1_term, "", "")
  call s:hi("DiffDelete", s:nord11_gui, s:bomb1_gui, s:nord11_term, s:nord1_term, "", "")
  call s:hi("DiffText", s:nord9_gui, s:bomb1_gui, s:nord9_term, s:nord1_term, "", "")
endif
...
call s:hi("ClapDisplay", s:nord4_gui, s:bomb1_gui, "", s:nord1_term, "", "")
...
call s:hi("IndentGuidesEven", "", s:bomb1_gui, "", s:nord1_term, "", "")
